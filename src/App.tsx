...
import ResponseContent from "./ResponseContent.tsx"; // i have created this Response component because the former layout was not allowing the response message to display with the format i wanted as per my prompt
...
function App() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      ...
      <h1 className="mb-5 text-2xl font-bold">NiceFace</h1>
